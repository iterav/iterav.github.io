...
function validateForm() {
	...
	if (!fields.value.email || !/\S+@\S+\.\S+/.test(fields.value.email)) {
				...
				<div class="flex flex-col lg:flex-row items-start justify-start gap-12 w-full">
					...
					<div class="flex flex-col items-start justify-start gap-8 p-8 w-full lg:w-1/3 text-white text-lg md:text-xl font-lexend font-normal rounded-xl bg-white/5 relative overflow-hidden">
						...
						<div class="flex flex-col items-start justify-start gap-4">
							...
							<ul>
								<li>
									<a href="https://wa.me/353870661737" title="Start a live chat" aria-label="Chat on WhatsApp" class="flex flex-row items-center justify-start gap-2 text-white hover:text-neutral-300 active:text-neutral-400 p-1 leading-none transition-colors duration-300 ease-in-out">
								...
								<li>
									<a href="mailto:hello@iterav.ie" title="Shoot us an email" aria-label="" class="flex flex-row items-center justify-start gap-2 text-white hover:text-neutral-300 active:text-neutral-400 p-1 leading-none transition-colors duration-300 ease-in-out">
										<svg class="w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="flex flex-col items-start justify-start gap-4">
							...
							<ul>
								<li>
									<a href="tel:0870661737" title="Call us" aria-label="" class="flex flex-row items-center justify-start gap-2 text-white hover:text-neutral-300 active:text-neutral-400 p-1 leading-none transition-colors duration-300 ease-in-out">
										<svg class="w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
