...
<template>
	<section id="experience" class="flex items-center justify-center bg-slate-800 border-px border-b border-white/5 py-20 relative">
		<div class="container flex flex-col items-start justify-start gap-8">
			<h2 class="text-white text-5xl font-xeola font-black tracking-wide drop-shadow-3xl">Experience</h2>
			<p class="text-white text-xl font-lexend font-bold">Proudly originating from Ireland and backed by over 30 years of combined experience, we have spent the past decade serving the corporate and commercial industries in Alberta, Canada.</p>
