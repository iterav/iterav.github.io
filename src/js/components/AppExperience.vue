...
<template>
	<section id="experience" class="flex items-center justify-center bg-slate-800 pt-20">
		<div class="container flex flex-col items-start justify-start gap-12 relative overflow-visible">
			<div class="flex flex-col items-start justify-center gap-8 text-white text-lg md:text-xl font-lexend font-normal leading-8 relative">
				<h2 class="text-white text-4xl md:text-5xl font-xeola font-black tracking-wide drop-shadow-3xl leading-none">AV Experience</h2>
